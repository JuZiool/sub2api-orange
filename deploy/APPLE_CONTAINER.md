...
```dotenv
APPLE_CONTAINER_SUB2API_IMAGE=ghcr.io/juziool/sub2api-orange:latest
...
SUB2API_IMAGE=ghcr.io/juziool/sub2api-orange:latest # Match APPLE_CONTAINER_SUB2API_IMAGE in .env.
