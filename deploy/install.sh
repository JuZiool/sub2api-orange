...
# Sub2API 安装脚本
# Usage: curl -sSL https://raw.githubusercontent.com/JuZiool/sub2api-orange/main/deploy/install.sh | bash
#
...
# Configuration
GITHUB_REPO="JuZiool/sub2api-orange"
...
Documentation=https://github.com/JuZiool/sub2api-orange
