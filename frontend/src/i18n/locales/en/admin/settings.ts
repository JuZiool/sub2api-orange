export default {
    settings: {
      ...
      codexQuotaOverdraftHint: 'Enabled by default. Eligible OpenAI OAuth accounts may perform bounded probing and keep being scheduled after upstream quota exhaustion. Disabling restores official scheduling and request behavior.',
