    ...
    settings: {
      ...
      gatewayForwarding: {
        ...
        codexTicketProxyTest: {
          ...
          test: 'Test exit',
          testing: 'Testing',
          hint: 'Test only the selected saved proxy and show its current exit IP and latency.',
          saveFirst: 'Proxy settings have changed. Save them before testing.',
          noProxy: 'Configure and save a harvest proxy first.',
          success: 'Proxy #{index} · Exit {ip} · {latency} ms',
          failed: 'Test failed: {reason}',
          errors: {
            invalid_proxy_index: 'Invalid proxy index; select a proxy again',
            proxy_not_configured: 'Proxy is not configured; save it and retry',
            settings_unavailable: 'Settings are temporarily unavailable; try again later',
            invalid_proxy: 'Invalid proxy URL; check the configuration',
            busy: 'This proxy is already being tested; retry shortly',
            redirect_blocked: 'The proxy returned a redirect, which was blocked',
            proxy_auth: 'Proxy authentication failed; check the credentials',
            timeout: 'Proxy test timed out',
            canceled: 'Proxy test canceled',
            proxy_error: 'Could not connect through the proxy',
            upstream_error: 'The exit service returned an error',
            invalid_response: 'The exit service returned unexpected content',
            unknown: 'Proxy test failed',
          },
        },
