    ...
    settings: {
      ...
      gatewayForwarding: {
        ...
        codexTicketProxyTest: {
          ...
          test: '测试出口',
          testing: '测试中',
          hint: '仅测试选中的已保存代理，显示当前出口 IP 和耗时。',
          saveFirst: '代理配置已修改，请先保存再测试出口。',
          noProxy: '请先配置并保存打票代理。',
          success: '代理 #{index} · 出口 {ip} · {latency} 毫秒',
          failed: '测试失败：{reason}',
          errors: {
            invalid_proxy_index: '代理序号无效，请重新选择',
            proxy_not_configured: '该代理尚未配置，请保存后重试',
            settings_unavailable: '暂时无法读取配置，请稍后重试',
            invalid_proxy: '代理 URL 无效，请检查配置',
            busy: '该代理正在测试，请稍后重试',
            redirect_blocked: '代理返回了重定向，已阻止',
            proxy_auth: '代理认证失败，请检查账号密码',
            timeout: '代理测试超时',
            canceled: '代理测试已取消',
            proxy_error: '代理连接失败',
            upstream_error: '出口服务返回异常',
            invalid_response: '出口返回内容异常',
            unknown: '代理测试失败',
          },
        },
