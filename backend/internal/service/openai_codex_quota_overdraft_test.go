...
func TestCodexQuotaOverdraftAccountSwitch(t *testing.T) {
	for _, test := range []struct {
		...
		},
		{
			...
			account: &Account{Platform: PlatformOpenAI, Type: AccountTypeOAuth, Extra: map[string]any{CodexQuotaOverdraftDisabledExtraKey: true}},
			enabled: false,
		},

		{
			name:    "non openai ignored",
			account: &Account{Platform: PlatformAnthropic, Type: AccountTypeOAuth, Extra: map[string]any{CodexQuotaOverdraftDisabledExtraKey: false}},
			enabled: false,
		},
		{
			name:    "shadow ignored",
			account: &Account{Platform: PlatformOpenAI, Type: AccountTypeOAuth, ParentAccountID: int64PtrForCodexQuotaOverdraftTest(1), Extra: map[string]any{CodexQuotaOverdraftDisabledExtraKey: false}},
			enabled: false,
		},
	} {
...
func TestCodexQuotaOverdraftDisabledAccountDoesNotInject(t *testing.T) {
	...
	account := &Account{
		...
		Type:     AccountTypeOAuth,
		Extra: map[string]any{
			CodexQuotaOverdraftDisabledExtraKey: true,
