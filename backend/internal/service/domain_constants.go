...
const (
	...
	// SettingKeyCodexQuotaOverdraftEnabled controls the runtime Codex quota-overdraft workflow.
	// When absent, the deployment gateway config remains authoritative.
