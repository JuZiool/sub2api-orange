...
func ProvideAdminHandlers(
	...
	accountHandler.SetCodexTicketGateway(openAIGateway)
	settingHandler.SetOpenAICodexTicketProxyTester(service.NewOpenAICodexTicketProxyTester(settingService))
