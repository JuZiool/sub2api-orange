...
func AccountListItemFromAccount(a *Account) *AccountListItem {
	...
	return &AccountListItem{
		...
		OllamaCloudUsage: a.OllamaCloudUsage, CodexTicketConfig: a.CodexTicketConfig, CodexTurnTickets: a.CodexTurnTickets,
		ProxyID: a.ProxyID, ProxyIDs: a.ProxyIDs, ProxyFallbackOriginID: a.ProxyFallbackOriginID, ProxyFallbackOriginName: a.ProxyFallbackOriginName, Concurrency: a.Concurrency, LoadFactor: a.LoadFactor, Priority: a.Priority, RateMultiplier: a.RateMultiplier,
