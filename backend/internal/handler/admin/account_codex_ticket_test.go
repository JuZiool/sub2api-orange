...
func TestAccountResponseCodexTicketsReadsLiveSettingsAfterRestart(t *testing.T) {
	...
	account := &service.Account{ID: 41, Platform: service.PlatformOpenAI, Type: service.AccountTypeSetupToken, Extra: map[string]any{service.OpenAICodexTicketEnabledExtraKey: true}}
